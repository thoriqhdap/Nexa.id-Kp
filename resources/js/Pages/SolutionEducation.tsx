...
const PRODUCTS_DATA: Product[] = [
  { id: 1, name: 'Learning Management System', icon: GraduationCap },
  { id: 2, name: 'Smart Classroom', icon: Monitor },
  { id: 3, name: 'Campus Internet Dedicated', icon: Wifi },
  { id: 4, name: 'Library Management System', icon: Library },
  { id: 5, name: 'E-Exam Portal', icon: FileText },
  { id: 6, name: 'School Payment Integration', icon: CreditCard },
  { id: 7, name: 'Parent & Student Portal', icon: Users },
  { id: 8, name: 'Academic ERP Systems', icon: Database },
]
...
const OTHER_SOLUTIONS: OtherSolution[] = [
  ...
  { id: 2, name: 'Pendidikan', icon: GraduationCap, href: '/solution/education', isActive: true },
...
// ==========================================
// MAIN COMPONENT: SolutionEducation
// ==========================================
export default function SolutionEducation() {
  return (
    <>
      <Head title="Solusi Pendidikan - Platform Belajar Cerdas & Konektivitas Kampus" />
      ...
      <main className="min-h-screen bg-white text-gray-900 font-sans selection:bg-orange-500 selection:text-white">
        ...
        <section 
          ...
          style={{ backgroundImage: "url('/images/solution-education.png')" }}
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              ...
              <div className="md:col-span-7 space-y-4 text-left max-w-xl lg:max-w-2xl">
                ...
                <h1 className="text-5xl sm:text-6xl font-black font-heading leading-tight tracking-tight">
                  ...
                  <span className="text-indigo-900 block">Pendidikan</span>
                </h1>
                <p className="text-lg font-medium text-black leading-relaxed max-w-md">
                  Penerapan platform pembelajaran digital dan infrastruktur internet cerdas untuk sekolah & kampus.
                </p>
                <div className="pt-4">
                  <a
                    href="#products"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16 space-y-3">
              ...
              <p className="text-gray-500 text-sm max-w-md mx-auto">
                Beberapa produk untuk solusi Education antara lain:
              </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-navy bg-[#1E1B4B] rounded-3xl p-10 md:p-16 text-white shadow-2xl relative overflow-hidden border border-white/5">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl font-black font-heading leading-snug max-w-md text-left">
                  Solusi digital cerdas yang siap meningkatkan efektivitas belajar-mengajar.
                </h3>
                {/* Right Side */}
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed text-left lg:border-l lg:border-white/10 lg:pl-10">
                  Mendukung transformasi digital akademis dari administrasi sekolah terpadu hingga ekosistem ujian online yang aman dan terpercaya.
                </p>
              </div>
            </div>
          </div>
              ...
              {OTHER_SOLUTIONS.map((solution) => {
                ...
                return (
                  <Link
                    key={solution.id}
                    href={solution.href}
                    className={`bg-white rounded-2xl p-6 border transition-all duration-300 flex flex-col items-center text-center cursor-pointer group ${solution.isActive
                        ? 'border-orange-500 shadow-md scale-[1.03]'
                        : 'border-gray-100 shadow-sm hover:border-orange-200 hover:shadow-md'
                      }`}
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors ${solution.isActive ? 'bg-orange-500 text-white' : 'bg-orange-50 text-orange-500 group-hover:bg-orange-100'
                      }`}>
        ...
        {/* 6. BottomCTA Section */}
        <section className="py-24 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-900 text-white text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
            ...
            <p className="text-indigo-100 text-sm max-w-md mx-auto leading-relaxed">
              Konsultasikan transformasi digital instansi pendidikan Anda bersama tim konsultan handal kami sekarang.
            </p>
            <div className="pt-4">
              <a
