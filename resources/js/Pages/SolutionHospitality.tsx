...
const PRODUCTS_DATA: Product[] = [
  { id: 1, name: 'Smart Hotel IPTV', icon: Tv },
  { id: 2, name: 'Hospitality PMS Integration', icon: Settings },
  { id: 3, name: 'High-Speed Guest WiFi', icon: Wifi },
  { id: 4, name: 'Keyless Smart Door Lock', icon: Key },
  { id: 5, name: 'In-Room IoT Control', icon: Cpu },
  { id: 6, name: 'Digital Concierge App', icon: Tablet },
  { id: 7, name: 'Banquet Audio-Visual Solutions', icon: Music },
  { id: 8, name: 'Hotel CRM Solutions', icon: HeartHandshake },
]
...
const OTHER_SOLUTIONS: OtherSolution[] = [
  ...
  { id: 3, name: 'Perhotelan', icon: Hotel, href: '/solution/hospitality', isActive: true },
...
// ==========================================
// MAIN COMPONENT: SolutionHospitality
// ==========================================
export default function SolutionHospitality() {
  return (
    <>
      <Head title="Solusi Perhotelan - Jaringan Internet Hotel & IPTV Cerdas" />
      ...
      <main className="min-h-screen bg-white text-gray-900 font-sans selection:bg-orange-500 selection:text-white">
        ...
        <section 
          ...
          style={{ backgroundImage: "url('/images/solution-hospitality.png')" }}
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              ...
              <div className="md:col-span-7 space-y-4 text-left max-w-xl lg:max-w-2xl">
                ...
                <h1 className="text-5xl sm:text-6xl font-black font-heading leading-tight tracking-tight">
                  ...
                  <span className="text-amber-400 block">Perhotelan</span>
                </h1>
                <p className="text-lg font-medium text-white leading-relaxed max-w-md">
                  Infrastruktur IPTV cerdas, otomasi kamar berbasis IoT, dan konektivitas berkecepatan tinggi demi kenyamanan tamu Anda.
                </p>
                <div className="pt-4">
                  <a 
                    href="#products" 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16 space-y-3">
              ...
              <p className="text-gray-500 text-sm max-w-md mx-auto">
                Beberapa produk untuk solusi Hospitality antara lain:
              </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-navy bg-[#78350F] rounded-3xl p-10 md:p-16 text-white shadow-2xl relative overflow-hidden border border-white/5">
              <div className="absolute right-0 top-0 w-80 h-80 bg-amber-500/10 rounded-full blur-3xl -z-10" />
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
                {/* Left Side */}
                <h3 className="text-2xl sm:text-3xl font-black font-heading leading-snug max-w-md text-left">
                  Pengalaman menginap tak terlupakan dengan sentuhan teknologi modern.
                </h3>
                {/* Right Side */}
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed text-left lg:border-l lg:border-white/10 lg:pl-10">
                  Mengintegrasikan sistem manajemen hotel (PMS) dengan Smart IPTV, IoT Smart Room, serta WiFi publik berkecepatan tinggi.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* 6. BottomCTA Section */}
        <section className="py-24 bg-gradient-to-r from-amber-600 via-amber-700 to-navy text-white text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
            ...
            <p className="text-amber-100 text-sm max-w-md mx-auto leading-relaxed">
              Konsultasikan solusi terintegrasi hospitality untuk meningkatkan kenyamanan tamu dan efisiensi operasional hotel Anda.
            </p>
            <div className="pt-4">
              <a 
