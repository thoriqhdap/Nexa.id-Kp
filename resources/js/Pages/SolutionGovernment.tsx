...
const PRODUCTS_DATA: Product[] = [
  { id: 1, name: 'Smart City Integration', icon: Building },
  { id: 2, name: 'E-Government Web Service', icon: Globe },
  { id: 3, name: 'Government Cloud Datacenter', icon: Server },
  { id: 4, name: 'Cyber Security Audit', icon: ShieldCheck },
  { id: 5, name: 'Public Area Managed WiFi', icon: Wifi },
  { id: 6, name: 'CCTV Traffic Monitoring', icon: Video },
  { id: 7, name: 'E-Procurement Portal', icon: FileCheck },
  { id: 8, name: 'Public Service Mobile App', icon: Smartphone },
]
...
const OTHER_SOLUTIONS: OtherSolution[] = [
  { id: 1, name: 'Pemerintah', icon: Building, href: '/solution/government', isActive: true },
...
// ==========================================
// MAIN COMPONENT: SolutionGovernment
// ==========================================
export default function SolutionGovernment() {
  return (
    <>
      <Head title="Solusi Pemerintah - Smart City & Infrastruktur Publik Digital" />
      ...
      <main className="min-h-screen bg-white text-gray-900 font-sans selection:bg-orange-500 selection:text-white">
        ...
        <section 
          ...
          style={{ backgroundImage: "url('/images/solution-government.png')" }}
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              ...
              <div className="md:col-span-7 space-y-4 text-left max-w-xl lg:max-w-2xl">
                ...
                <h1 className="text-5xl sm:text-6xl font-black font-heading leading-tight tracking-tight">
                  ...
                  <span className="text-slate-800 block">Pemerintah</span>
                </h1>
                <p className="text-lg font-medium text-black leading-relaxed max-w-md">
                  Infrastruktur jaringan publik yang aman, pusat data tersertifikasi, dan integrasi sistem Smart City.
                </p>
                <div className="pt-4">
                  <a 
                    href="#products" 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16 space-y-3">
              ...
              <p className="text-gray-500 text-sm max-w-md mx-auto">
                Beberapa produk untuk solusi Government antara lain:
              </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-navy bg-[#1E293B] rounded-3xl p-10 md:p-16 text-white shadow-2xl relative overflow-hidden border border-white/5">
              <div className="absolute right-0 top-0 w-80 h-80 bg-slate-500/10 rounded-full blur-3xl -z-10" />
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
                {/* Left Side */}
                <h3 className="text-2xl sm:text-3xl font-black font-heading leading-snug max-w-md text-left">
                  Infrastruktur digital publik terpercaya demi pelayanan masyarakat prima.
                </h3>
                {/* Right Side */}
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed text-left lg:border-l lg:border-white/10 lg:pl-10">
                  Mendukung keterbukaan informasi publik dan digitalisasi tata kelola administrasi pemerintahan secara aman, andal, dan akuntabel.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* 6. BottomCTA Section */}
        <section className="py-24 bg-gradient-to-r from-slate-700 via-slate-800 to-navy text-white text-center relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
            ...
            <p className="text-slate-200 text-sm max-w-md mx-auto leading-relaxed">
              Diskusikan kebutuhan audit keamanan siber, tata kelola data center, dan integrasi Smart City instansi Anda bersama tim kami.
            </p>
            <div className="pt-4">
              <a 
