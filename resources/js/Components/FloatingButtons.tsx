...
export default function FloatingButtons() {
  ...
  return (
    <>
      <button
        onClick={scrollToTop}
        className={`fixed bottom-24 right-6 w-14 h-14 bg-orange-500 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:bg-orange-400 hover:scale-110 z-50 ${
